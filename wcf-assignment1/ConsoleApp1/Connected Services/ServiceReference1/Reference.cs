...
namespace ConsoleApp1.ServiceReference1 {
    ...
    public interface IService1 {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/checkPrime", ReplyAction="http://tempuri.org/IService1/checkPrimeResponse")]
        System.Threading.Tasks.Task<string> checkPrimeAsync(int value);
    }
    ...
    public partial class Service1Client : System.ServiceModel.ClientBase<ConsoleApp1.ServiceReference1.IService1>, ConsoleApp1.ServiceReference1.IService1 {
        ...
        public string checkPrime(int value) {
            return base.Channel.checkPrime(value);
        }
        
        public System.Threading.Tasks.Task<string> checkPrimeAsync(int value) {
            return base.Channel.checkPrimeAsync(value);
        }
    }
}
